{/*this components to search music & merch on music & merch page  */}
...
const SearchBar = () => {
    ...
    {/*this is to make sure when the search bar appear or hidden*/}
    useEffect(() => {
    ...
    {/*if showSearch =true and path= visible */}
    ...
    ) : null; // return null if condition is not meet 
};
